...
import { Scenario01CameraPermissionDeniedScenario as scenario, evaluateScenario01CameraPermissionDeniedScenario } from '../scenarios/01-camera-permission-denied';

describe('release scenario 01-camera-permission-denied', () => {
  it('has a stable identity and domain', () => {
    expect(scenario.id).toBe('01-camera-permission-denied');
  ...
  expect(scenario.steps[0].id).toBe('01-camera-permission-denied-step-01');
  ...
  expect(scenario.steps[1].id).toBe('01-camera-permission-denied-step-02');
  ...
  expect(scenario.steps[2].id).toBe('01-camera-permission-denied-step-03');
  ...
  expect(scenario.steps[3].id).toBe('01-camera-permission-denied-step-04');
  ...
  expect(scenario.steps[4].id).toBe('01-camera-permission-denied-step-05');
  ...
  expect(scenario.steps[5].id).toBe('01-camera-permission-denied-step-06');
  ...
  expect(scenario.steps[6].id).toBe('01-camera-permission-denied-step-07');
  ...
  expect(scenario.steps[7].id).toBe('01-camera-permission-denied-step-08');
  ...
  expect(scenario.steps[8].id).toBe('01-camera-permission-denied-step-09');
  ...
  expect(scenario.steps[9].id).toBe('01-camera-permission-denied-step-10');
  ...
  expect(scenario.steps[10].id).toBe('01-camera-permission-denied-step-11');
  ...
  expect(scenario.steps[11].id).toBe('01-camera-permission-denied-step-12');
  ...
  expect(scenario.steps[12].id).toBe('01-camera-permission-denied-step-13');
  ...
  expect(scenario.steps[13].id).toBe('01-camera-permission-denied-step-14');
  ...
  expect(scenario.steps[14].id).toBe('01-camera-permission-denied-step-15');
  ...
  expect(scenario.steps[15].id).toBe('01-camera-permission-denied-step-16');
  ...
  expect(scenario.steps[16].id).toBe('01-camera-permission-denied-step-17');
  ...
  expect(scenario.steps[17].id).toBe('01-camera-permission-denied-step-18');
  ...
  expect(scenario.steps[18].id).toBe('01-camera-permission-denied-step-19');
  ...
  expect(scenario.steps[19].id).toBe('01-camera-permission-denied-step-20');
  ...
  expect(scenario.steps[20].id).toBe('01-camera-permission-denied-step-21');
  ...
  expect(scenario.steps[21].id).toBe('01-camera-permission-denied-step-22');
  ...
  expect(scenario.steps[22].id).toBe('01-camera-permission-denied-step-23');
  ...
  expect(scenario.steps[23].id).toBe('01-camera-permission-denied-step-24');
  ...
  it('starts incomplete', () => {
    const result = evaluateScenario01CameraPermissionDeniedScenario([]);
  ...
  it('passes only when every checkpoint completes', () => {
    ...
    const result = evaluateScenario01CameraPermissionDeniedScenario(completed);
