...
import { Scenario72PrivacyDataDeletionScenario as scenario, evaluateScenario72PrivacyDataDeletionScenario } from '../scenarios/72-privacy-data-deletion';

describe('release scenario 72-privacy-data-deletion', () => {
  it('has a stable identity and domain', () => {
    expect(scenario.id).toBe('72-privacy-data-deletion');
    expect(scenario.domain).toBe('privacy');
    expect(scenario.title).toContain('data deletion');
  });

  it('has all 24 deterministic checkpoints', () => {
    expect(scenario.steps).toHaveLength(24);
  expect(scenario.steps[0].id).toBe('72-privacy-data-deletion-step-01');
  ...
  expect(scenario.steps[1].id).toBe('72-privacy-data-deletion-step-02');
  ...
  expect(scenario.steps[2].id).toBe('72-privacy-data-deletion-step-03');
  ...
  expect(scenario.steps[3].id).toBe('72-privacy-data-deletion-step-04');
  ...
  expect(scenario.steps[4].id).toBe('72-privacy-data-deletion-step-05');
  ...
  expect(scenario.steps[5].id).toBe('72-privacy-data-deletion-step-06');
  ...
  expect(scenario.steps[6].id).toBe('72-privacy-data-deletion-step-07');
  ...
  expect(scenario.steps[7].id).toBe('72-privacy-data-deletion-step-08');
  ...
  expect(scenario.steps[8].id).toBe('72-privacy-data-deletion-step-09');
  ...
  expect(scenario.steps[9].id).toBe('72-privacy-data-deletion-step-10');
  ...
  expect(scenario.steps[10].id).toBe('72-privacy-data-deletion-step-11');
  ...
  expect(scenario.steps[11].id).toBe('72-privacy-data-deletion-step-12');
  ...
  expect(scenario.steps[12].id).toBe('72-privacy-data-deletion-step-13');
  ...
  expect(scenario.steps[13].id).toBe('72-privacy-data-deletion-step-14');
  ...
  expect(scenario.steps[14].id).toBe('72-privacy-data-deletion-step-15');
  ...
  expect(scenario.steps[15].id).toBe('72-privacy-data-deletion-step-16');
  ...
  expect(scenario.steps[16].id).toBe('72-privacy-data-deletion-step-17');
  ...
  expect(scenario.steps[17].id).toBe('72-privacy-data-deletion-step-18');
  ...
  expect(scenario.steps[18].id).toBe('72-privacy-data-deletion-step-19');
  ...
  expect(scenario.steps[19].id).toBe('72-privacy-data-deletion-step-20');
  ...
  expect(scenario.steps[20].id).toBe('72-privacy-data-deletion-step-21');
  ...
  expect(scenario.steps[21].id).toBe('72-privacy-data-deletion-step-22');
  ...
  expect(scenario.steps[22].id).toBe('72-privacy-data-deletion-step-23');
  ...
  expect(scenario.steps[23].id).toBe('72-privacy-data-deletion-step-24');
  ...
  it('starts incomplete', () => {
    const result = evaluateScenario72PrivacyDataDeletionScenario([]);
  ...
  it('passes only when every checkpoint completes', () => {
    ...
    const result = evaluateScenario72PrivacyDataDeletionScenario(completed);
