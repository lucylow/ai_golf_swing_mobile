...
import { Scenario34MediaUnsupportedFormatScenario as scenario, evaluateScenario34MediaUnsupportedFormatScenario } from '../scenarios/34-media-unsupported-format';

describe('release scenario 34-media-unsupported-format', () => {
  it('has a stable identity and domain', () => {
    expect(scenario.id).toBe('34-media-unsupported-format');
    expect(scenario.domain).toBe('media');
    expect(scenario.title).toContain('unsupported format');
  });

  it('has all 24 deterministic checkpoints', () => {
    expect(scenario.steps).toHaveLength(24);
  expect(scenario.steps[0].id).toBe('34-media-unsupported-format-step-01');
  ...
  expect(scenario.steps[1].id).toBe('34-media-unsupported-format-step-02');
  ...
  expect(scenario.steps[2].id).toBe('34-media-unsupported-format-step-03');
  ...
  expect(scenario.steps[3].id).toBe('34-media-unsupported-format-step-04');
  ...
  expect(scenario.steps[4].id).toBe('34-media-unsupported-format-step-05');
  ...
  expect(scenario.steps[5].id).toBe('34-media-unsupported-format-step-06');
  ...
  expect(scenario.steps[6].id).toBe('34-media-unsupported-format-step-07');
  ...
  expect(scenario.steps[7].id).toBe('34-media-unsupported-format-step-08');
  ...
  expect(scenario.steps[8].id).toBe('34-media-unsupported-format-step-09');
  ...
  expect(scenario.steps[9].id).toBe('34-media-unsupported-format-step-10');
  ...
  expect(scenario.steps[10].id).toBe('34-media-unsupported-format-step-11');
  ...
  expect(scenario.steps[11].id).toBe('34-media-unsupported-format-step-12');
  ...
  expect(scenario.steps[12].id).toBe('34-media-unsupported-format-step-13');
  ...
  expect(scenario.steps[13].id).toBe('34-media-unsupported-format-step-14');
  ...
  expect(scenario.steps[14].id).toBe('34-media-unsupported-format-step-15');
  ...
  expect(scenario.steps[15].id).toBe('34-media-unsupported-format-step-16');
  ...
  expect(scenario.steps[16].id).toBe('34-media-unsupported-format-step-17');
  ...
  expect(scenario.steps[17].id).toBe('34-media-unsupported-format-step-18');
  ...
  expect(scenario.steps[18].id).toBe('34-media-unsupported-format-step-19');
  ...
  expect(scenario.steps[19].id).toBe('34-media-unsupported-format-step-20');
  ...
  expect(scenario.steps[20].id).toBe('34-media-unsupported-format-step-21');
  ...
  expect(scenario.steps[21].id).toBe('34-media-unsupported-format-step-22');
  ...
  expect(scenario.steps[22].id).toBe('34-media-unsupported-format-step-23');
  ...
  expect(scenario.steps[23].id).toBe('34-media-unsupported-format-step-24');
  ...
  it('starts incomplete', () => {
    const result = evaluateScenario34MediaUnsupportedFormatScenario([]);
  ...
  it('passes only when every checkpoint completes', () => {
    ...
    const result = evaluateScenario34MediaUnsupportedFormatScenario(completed);
