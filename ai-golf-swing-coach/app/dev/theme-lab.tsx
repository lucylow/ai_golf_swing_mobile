        ...
        <View className="gap-4 pb-8">
          {__DEV__ ? (
            <Pressable
              ...
              accessibilityLabel="Open sanitized diagnostics"
              onPress={() => router.push("/dev/diagnostics")}
              style={({ pressed }) => [styles.devButton, { backgroundColor: colors.tint }, pressed && { opacity: 0.75 }]}
            >
              <Text style={styles.devButtonTitle}>Open sanitized diagnostics</Text>
              <Text style={styles.devButtonSubtitle}>Inspect local failure categories without sensitive payloads</Text>
            </Pressable>
          ) : null}
